...
public class ViveFoveatedVisualizer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var shader = Shader.Find("Hidden/VisualizeViveFoveatedRendering");
        if (shader == null)
        {
            Debug.LogError("Failed to find shader: Hidden/VisualizeViveFoveatedRendering");
        }
        else
        {
            visualizeMat = new Material(shader);
            Debug.Log("Shader is successfully attached to the material.");
        }
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        if (visualizeMat != null)
        {
            ...
            Debug.Log($"_GazeData: {gazeData.x}, {gazeData.y}");
            ...
            Debug.Log($"Inner radii: {innerRadii}");
            Debug.Log($"Middle radii: {middleRadii}");
            Debug.Log($"Peripheral radii: {peripheralRadii}");
